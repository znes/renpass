...
Examples:
  ...
  renpass_gis_main.py -o cbc path/to/scenario.csv path/to/scenario-seq.csv
...
Full example 
  renpass_gis_main.py -o cbc --date-from="2050-01-01 00:00:00" --date-to="2050-12-31 23:00:00" scenarios/jordan_2050_scenario_a.csv scenarios/jordan_2050_seq.csv
"""
...
#%% write results in csv
     ...
     # sort columns and save as csv file
file_name = 'scenario' + scenario_name + date + '_' + \
...
###file = ('results/scenario_morocco_2050_scenario_a_2016-12-07_18-32-25_MA.csv')
