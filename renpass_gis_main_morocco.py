...
Usage:
  renpass_gis_main_morocco.py [options] NODE_DATA SEQ_DATA
  renpass_gis_main_morocco.py -h | --help | --version

Examples:

  renpass_gis_main_morocco.py -o cbc path/to/scenario.csv path/to/scenario-seq.csv
...
Full example 
  renpass_gis_main-morocco.py -o cbc --date-from="2050-01-01 00:00:00" --date-to="2050-12-31 23:00:00" scenarios/morocco_2050_scenario_a.csv scenarios/morocco_2050_seq.csv
"""
...
##arguments = {'NODE_DATA':'scenarios/morocco_2050_scenario_a.csv',
#        'SEQ_DATA':'scenarios/morocco_2050_seq.csv',
#       '-o cbci',
...
#%% create dataframe and replace MAdr01 and so on (number: regular expresseion) with MA
df = df[idx]

df = df.replace('MAdr\d\d', value='MA', regex = True)

#%% sum up all the dispatch region to get hourly data for whole Morocco for each technology
